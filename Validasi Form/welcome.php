...
if (isset($_POST["submit"])) {
    ...
    if ($password === $cpassword) {
        ...
        if ($photo_size > 5242880) {
            ...
            $sql = "UPDATE users SET nama_lengkap='$nama_lengkap', password='$password', photo='$photo_new_name' WHERE id='{$_SESSION["user_id"]}'";
...
<body class="profile-page">
    <div class="wrapper">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            ?>
                    <div class="inputBox">
                        <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $row['nama_lengkap']; ?>" required>
                    </div>
                    <div class="inputBox">
                        <input type="email" id="email" name="email" placeholder="Alamat Email" value="<?php echo $row['email']; ?>" disabled required>
                    </div>
                    <div class="inputBox">
                        <input type="numeric" id="nomor" name="nomor" placeholder="Nomor Telepon" value="<?php echo $row['nomor']; ?>" disabled required>
                    </div>
                    <div class="inputBox">
