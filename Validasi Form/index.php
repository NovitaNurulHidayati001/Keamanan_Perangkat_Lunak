...
if (isset($_POST["signup"])) {
  $nama_lengkap = mysqli_real_escape_string($conn, $_POST["signup_nama_lengkap"]);
  $email = mysqli_real_escape_string($conn, $_POST["signup_email"]);
  $nomor = mysqli_real_escape_string($conn, md5($_POST["signup_nomor"]));
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (nama_lengkap, email, nomor, password, token, status) VALUES ('$nama_lengkap', '$email', '$nomor', '$password', '$token', '0')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $_POST["signup_nama_lengkap"] = "";
      $_POST["signup_email"] = "";
      $_POST["signup_nomor"] = "";
      ...
      <body>
      <p><strong>Hallo {$nama_lengkap},</strong></p>
      ...
      <div class="signin-signup">
        <form action="" method="post" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="Alamat Email" name="email" value="<?php echo $_POST['email']; ?>" required />
          </div>
          <div class="input-field">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Nama Lengkap" name="signup_nama_lengkap" value="<?php echo $_POST["signup_nama_lengkap"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="email" placeholder="Alamat Email" name="signup_email" value="<?php echo $_POST["signup_email"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="numeric" placeholder="Nomor Telepon" name="signup_nomor" value="<?php echo $_POST["signup_nomor"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>New here ?</h3>
          <p>
            Don't have already an account? Register Here!
          </p>
